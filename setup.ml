...
(* OASIS_START *)
(* DO NOT EDIT (digest: 687f3c7db6698bfad4625d2b4bfd08ba) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hannesm/jackline";
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "jackline.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\223PGG\156\196X\128\221\197\156\183\252\175W\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
