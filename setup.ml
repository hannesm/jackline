...
(* OASIS_START *)
(* DO NOT EDIT (digest: d7fb08315c40457c483bbbcf80b08686) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description = Some [OASISText.Para "Console XMPP client with OTR"];
          categories = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Cli_config"; "Cli_client"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("lambda-term", None);
                           FindlibPackage ("react", None);
                           InternalLibrary "xmpp_client_cli";
                           InternalLibrary "xmpp_client"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "cli_main.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "C\171N\247\007\228\209N\000\254\229\241C%=\\";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
