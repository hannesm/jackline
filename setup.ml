...
(* OASIS_START *)
(* DO NOT EDIT (digest: 69876dab27ffb6e4901c9f095aa251ec) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hannesm/xmpp-client";
          synopsis = "XMPP Client";
          description =
            Some [OASISText.Para "Graphical XMPP client with OTR"];
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "GUI interface (GTK2)";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cli_client.ml"});
               Executable
                 ({
                     cs_name = "gui_client";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "gui_client.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "5\128\178\151\147\200\143\030\1493\254\144\147\144/\002";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
